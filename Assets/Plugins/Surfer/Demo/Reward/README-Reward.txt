...
1) MainCamera->SUElement-> 1)Scene-MySceneLoaded : DO... : Surfer/OpenState : State : “choose the state you want from the list”

2)Canvas->Panel-> SUElement : State : “choose the state used in step 1”
