...
namespace Surfer
{
    [CustomPropertyDrawer(typeof(SUScenesData))]
    public class SUScenesDataDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            property.isExpanded = EditorGUI.Foldout(position, property.isExpanded, "Scenes", true);
